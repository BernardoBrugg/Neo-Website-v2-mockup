  ...
  return (
    <section className="relative z-10 w-full px-4 py-16 sm:px-6 md:py-24 lg:px-8 pointer-events-none">
      <motion.div 
        ...
        className="glass pointer-events-auto mx-auto flex max-w-4xl flex-col items-center gap-6 rounded-[3rem] p-10 text-center shadow-2xl sm:gap-8 sm:p-14 md:p-20"
      >
        <h2 className="font-extrabold text-[clamp(2.5rem,5vw,5.5rem)] leading-tight">Faça parte do <span className="text-neo-orange">NEO!</span></h2>
        <p className="max-w-2xl text-[clamp(1rem,2vw,1.25rem)] text-zinc-600 dark:text-zinc-300 md:leading-relaxed">
